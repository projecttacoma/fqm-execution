...
- [CQL-to-ELM Translator](https://github.com/cqframework/clinical_quality_language/blob/main/Src/java/cql-to-elm/README.md): Often used to generate ELM, which fqm-execution can execute, from CQL.
