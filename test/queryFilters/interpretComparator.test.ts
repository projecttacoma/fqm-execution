...
const ValueQueryComparator = getELMFixture('elm/queries/ValueQueryComparator.json');
...
describe('interpretComparator cases', () => {
  test('interpretComparator with type Greater returns correct filter', () => {
    ...
    const valueFilter = QueryFilter.interpretComparator(validGreaterFilter, ValueQueryComparator, 'gt');
  ...
  test('interpretComparator with type Less returns correct filter', () => {
    ...
    const valueFilter = QueryFilter.interpretComparator(validGreaterFilter, ValueQueryComparator, 'lt');
    expect(valueFilter).toEqual({
      attribute: 'value',
      comparator: 'lt',
      type: 'value',
  ...
  test('interpretComparator with type GreaterOrEqual returns correct filter', () => {
    ...
    const valueFilter = QueryFilter.interpretComparator(validGreaterFilter, ValueQueryComparator, 'ge');
    expect(valueFilter).toEqual({
      attribute: 'value',
      comparator: 'ge',
      type: 'value',
  ...
  test('interpretComparator with type LessOrEqual returns correct filter', () => {
    ...
    const valueFilter = QueryFilter.interpretComparator(validGreaterFilter, ValueQueryComparator, 'le');
    expect(valueFilter).toEqual({
      attribute: 'value',
      comparator: 'le',
      type: 'value',
  ...
  test('interpretComparator with invalid operand returns unknown filter with error', () => {
    ...
    const valueFilter = QueryFilter.interpretComparator(invalidGreaterFilter, ValueQueryComparator, 'gt');
    expect(valueFilter).toEqual({
      type: 'unknown',
...
describe('interpretGreater cases', () => {
  test('interpretGreater returns correct value filter', () => {
    ...
    const valueFilter = QueryFilter.interpretGreater(validGreaterFilter, ValueQueryComparator);
    expect(valueFilter).toEqual({
      attribute: 'value',
      comparator: 'gt',
      type: 'value',
...
describe('interpretLess cases', () => {
  test('interpretLess returns correct value filter', () => {
    ...
    const valueFilter = QueryFilter.interpretLess(validLessFilter, ValueQueryComparator);
    expect(valueFilter).toEqual({
      attribute: 'value',
      comparator: 'lt',
      type: 'value',
...
describe('interpretLessOrEqual cases', () => {
  test('interpretLessOrEqual returns correct value filter', () => {
    ...
    const valueFilter = QueryFilter.interpretLessOrEqual(validLessOrEqualFilter, ValueQueryComparator);
    expect(valueFilter).toEqual({
      attribute: 'value',
      comparator: 'le',
      type: 'value',
