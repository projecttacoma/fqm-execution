...
Next, add a target to the `Makefile` with the necessary `ecqm-bundler` command to generate the measure bundle. See [the ecqm-bundler documentation](https://github.com/projecttacoma/ecqm-bundler#usage) for more information.
