...
export function findAllLocalIdsInSort(
  ...
  emptyResultClauses.push({
    lib: libraryName,
    aliasLocalId: alId,
    // Between translator versions 3.3.2 and 3.14.0, a localId was added to the rootStatement of a sort clause
...
export function isSupplementalDataElementStatement(
  ...
  if (supplementalDataElements != undefined) {
    for (const supplementalData of supplementalDataElements) {
      // text/cql-identifier is correct (https://hl7.org/fhir/us/cqfmeasures/STU5/measure-conformance.html#conformance-requirement-3-7),
